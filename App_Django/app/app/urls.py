...
from insumos.api.router import router_insumos

schema_view = get_schema_view(
    openapi.Info(
        title="RestaurAppp - ApiDoc",
        default_version='v1',
        description="Documentación de la api de Restaurapp",
...
urlpatterns = [
    ...
    path('api/', include (router_insumos.urls)),
]
